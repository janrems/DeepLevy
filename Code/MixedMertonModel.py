...
financial_parameters = {
    ...
    'MC_sample_size': 500000,   # Sample size for MC
    'MC_R': 300               # Number of time steps for MC
}
...
#######################################
class MixedMerton():
    def __init__(self,market_name,T,drift,volatility,s0,r,rates,mus,sigmas,K,R, MC_sample_size, MC_R):
...
fin_model = MixedMerton("MixedMerton",financial_parameters["T"],financial_parameters["drift"],
                   ...
                   financial_parameters["K"],ml_parameters["R"], financial_parameters["MC_sample_size"],
